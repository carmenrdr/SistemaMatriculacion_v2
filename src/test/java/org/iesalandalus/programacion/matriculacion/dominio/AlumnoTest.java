...
public class AlumnoTest {
    ...
    private static final String TELEFONO_NO_ESPERADO = "El telefono devuelto no es el mismo que el pasado al constructor.";
    ...
    private static final String NIA_NO_ESPERADO = "El calculo del Numero de Identificacion del Alumno no es el correcto.";
    ...
    private static final String NOMBRE_MAL_ARDR = "  ANDRES   RuBiO   dEl             rio";
    ...
    private static final String NOMBRE_INCORRECTO = "Deberia haber saltado una excepcion indicando que el nombre es incorrecto";
    private static final String ERROR_NOMBRE_NULO = "ERROR: El nombre de un alumno no puede ser nulo.";
    private static final String ERROR_NOMBRE_NO_VALIDO = "ERROR: El nombre de un alumno no puede estar vacio.";
    private static final String DNI_INCORRECTO = "Deberia haber saltado una excepcion indicando que el DNI es incorrecto";
    private static final String ERROR_DNI_NULO = "ERROR: El dni de un alumno no puede ser nulo.";
    private static final String ERROR_DNI_NO_VALIDO = "ERROR: El dni del alumno no tiene un formato valido.";
    private static final String ERROR_CORREO_NULO = "ERROR: El correo de un alumno no puede ser nulo.";
    private static final String CORREO_INCORRECTO = "Deberia haber saltado una excepcion indicando que el correo es incorrecto";
    private static final String ERROR_CORREO_NO_VALIDO = "ERROR: El correo del alumno no tiene un formato valido.";
    private static final String ERROR_TELEFONO_NO_VALIDO = "ERROR: El telefono del alumno no tiene un formato valido.";

    private static final String MENSAJE_EXCEPCION_NO_CORRECTO = "El mensaje devuelto por la excepcion no es correcto.";
    private static final String OBJETO_DEBERIA_SER_NULO = "No se deberia haber creado el objeto alumno.";
    private static final String ERROR_LETRA_DNI_NO_VALIDA = "ERROR: La letra del dni del alumno no es correcta.";
    private static final String TELEFONO_INCORRECTO = "Deberia haber saltado una excepcion indicando que el telefono es incorrecto";

    private static final String ERROR_TELEFONO_NULO = "ERROR: El telefono de un alumno no puede ser nulo.";
    private static final String FECHA_NACIMIENTO_INCORRECTA = "Deberia haber saltado una excepcion indicando que la fecha de nacimiento es incorrecta";
    ...
    private static final String ALUMNO_NO_ESPERADO = "El alumno copiado deberia ser el mismo que el pasado como parametro.";
    private static final String ALUMNO_NULO = "Deberia haber saltado una excepcion indicando que no se puede copiar un alumno nulo.";
